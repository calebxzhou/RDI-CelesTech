...
public class CopyHomeCmd extends BaseCommand {

    public CopyHomeCmd(String name, int permissionLevel, boolean enabled) {
    ...
    private int execute(CommandSource source) throws CommandSyntaxException {
        TextUtils.sendChatMessage(source.asPlayer(),"您想要分享哪个家？");
