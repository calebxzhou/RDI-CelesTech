...
public class SetSpawnPointCmd extends BaseCommand {

    public SetSpawnPointCmd(String command, int permissionLevel, boolean enabled) {
    ...
    private int execute(CommandSource source) throws CommandSyntaxException {
        ...
        TextUtils.clickableContent2Send(player, EColor.GOLD.code+"[]","",
                "");
