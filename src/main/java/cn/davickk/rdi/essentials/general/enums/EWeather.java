...
public enum EWeather {
    ...
    CLEAR_DAY(EColor.GOLD.code+"晴[白天]"+EColor.RESET.code, 0),
    CLEAR_NIGHT(EColor.GOLD.code+"晴[夜间]"+EColor.RESET.code, 1),
    PARTLY_CLOUDY_DAY("多云[白天]", 2),
    PARTLY_CLOUDY_NIGHT("多云[夜间]", 3),
