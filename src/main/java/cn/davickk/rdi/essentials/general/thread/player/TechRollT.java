...
public class TechRollT extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            itemList.add(new Items2Give(AE+"sky_stone_block","[陨石]",base/8.0,8));
            itemList.add(new Items2Give("experience","[3经验]",base/2.0,3));
            itemList.add(new Items2Give(AE+"charged_quartz_ore","[充能石英]",base/8.0,2));
            itemList.add(new Items2Give(AE+"calculation_processor_press","[运算压印板]",base/10.0,1));
            itemList.add(new Items2Give(AE+"silicon_press","[硅压印板]",base/10.0,1));
