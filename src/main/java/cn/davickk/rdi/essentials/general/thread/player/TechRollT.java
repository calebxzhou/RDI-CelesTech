...
public class TechRollT extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            */
            itemList.add(new Items2Give(MEK+"fluorite_ore","[氟石]",base/6.0,2));

            itemList.add(new Items2Give("experience","[5经验]",base/15.0,5));
            itemList.add(new Items2Give("creeper","[闪电苦力怕]",base/8.0,1));
            itemList.add(new Items2Give(MC+"cow_spawn_egg","[牛]",base/12.0,1));
            itemList.add(new Items2Give(MC+"sheep_spawn_egg","[羊]",base/12.0,1));
            itemList.add(new Items2Give(MC+"chicken_spawn_egg","[鸡]",base/12.0,1));
            itemList.add(new Items2Give(MC+"prismarine_crystals","[海晶砂石]",base/12.0,1));
