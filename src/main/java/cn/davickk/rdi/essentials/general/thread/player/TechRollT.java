...
public class TechRollT extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            itemList.add(new Items2Give(MC+"cow_spawn_egg","[牛]",base/15.0,1));
            itemList.add(new Items2Give(MC+"sheep_spawn_egg","[羊]",base/15.0,1));
            itemList.add(new Items2Give(MC+"chicken_spawn_egg","[鸡]",base/18.0,1));
