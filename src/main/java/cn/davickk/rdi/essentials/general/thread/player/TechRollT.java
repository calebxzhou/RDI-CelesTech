...
public class TechRollT extends Thread {
    ...
    public void run() {
        ...
        itemList.add(new Items2Give(MC+"dirt","[泥土]",0.2));
        itemList.add(new Items2Give(MC+"cobblestone","[圆石]",0.3));
        itemList.add(new Items2Give(MC+"jungle_sapling","[丛林树苗]",0.1));
        itemList.add(new Items2Give(MC+"nether_quartz_ore","[地狱石英矿]",0.05));
        itemList.add(new Items2Give(MC+"netherite","[下界合金]",0.05));
        ...
        itemList.add(new Items2Give(AE+"engineering_processor_press","[泥土]",0.02));
        ...
        for(Items2Give itm:itemList){
            if(RandomUtils.randomPercentage(itm.percent)){
                try {
                    TextUtils.sendChatMessage(player,"恭喜您抽中了"+itm.itemDescription);
